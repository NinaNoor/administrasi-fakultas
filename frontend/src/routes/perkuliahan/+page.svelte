...
:global(body, html) {
  ...
  .page-container {
    flex: 1;
    background: linear-gradient(to right, #C026D3, #9333EA); /* light mode: teal-400 to yellow-200 */
    overflow-y: auto;
    margin-top: -4rem;
    padding-top: 4rem;
  }
  ...
  :global(.dark) .page-container {
    background: linear-gradient(to right, #86198F, #581C87); /* dark mode: teal-800 to yellow-700 */
  }
</style>