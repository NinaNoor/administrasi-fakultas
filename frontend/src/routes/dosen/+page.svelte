...
:global(body, html) {
  ...
  .page-container {
    flex: 1;
    background: linear-gradient(to right, #2563EB, #7C3AED); /* light mode: teal-400 to yellow-200 */
    overflow-y: auto;
    margin-top: -4rem;
    padding-top: 4rem;
  }
  ...
  :global(.dark) .page-container {
    background: linear-gradient(to right, #1E40AF, #4C1D95); /* dark mode: teal-800 to yellow-700 */
  }
</style>